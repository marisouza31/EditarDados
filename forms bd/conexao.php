<?php 
    ...
    $sqlInserir = "INSERT INTO `dadoscliente`(`nome`, `telefone`, `origem`, `dataContato`, `observacao`) VALUES ('$nome','$telefone','$origem','$dataContato','$observacao')";
...
<body style="background-color: grey;">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col">
                <h2 class="resultado__titulo">o cadastro foi realizado</h1>
            </div>
        </div>
    </div>
</body>
